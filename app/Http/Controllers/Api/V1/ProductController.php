...
class ProductController extends Controller
{
    ...
    public function get_popular_products(Request $request)
    {
        ...
        $list = Food::where('type_id', 2)->take(10)->latest()->get();
    ...
    {
        $list = Food::where('type_id', 3)->take(10)->latest()->get();
    ...
    {
        $list = Food::where('type_id', 4)->take(10)->latest()->get();
    ...
    public function test_get_recommended_products(Request $request)
    {
        ...
        $list = Food::skip(5)->take(2)->latest()->get();
